...
void AEnemySpawner::BeginPlay()
{
	...
	// add this to the list of spawners in encounter
	if(temp)
	{
...
// spawn enemy and add it to encounter's list of enemy instances , when those instances are 0 end encounter or start a new wave
